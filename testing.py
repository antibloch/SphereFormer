...
def validate(val_loader, model, criterion):
    ...
    # print elements in val_loader

    for i, (coord, xyz, feat, target, offset, inds_reconstruct) in enumerate(val_loader):
        ...
        colors = np.zeros((args.classes, 3))
        ...
        pcd.visualizaion.draw_geometries([pcd])
